class CreateProducts < ActiveRecord::Migration
  ...
  def self.up
    create_table :products do |t|
      ...
      t.string :name
      t.text :description
      t.integer :brochure_path_id
      t.integer :cutsheet_path_id
      t.integer :drawing_path_id
      t.integer :specsheet_path_id
      t.integer :user_manual_path_id
      t.integer :instruction_manual_path_id
